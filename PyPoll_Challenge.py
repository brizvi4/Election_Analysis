...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (c_votes > most_county_votes_count):
            most_county_votes_count = c_votes
            most_county_votes = county_name

    # 7: Print the county with the largest turnout to the terminal.
    largest_conunty_turnout = (
        f"-------------------------\n"
        f"Largest County Turnout: {most_county_votes}\n"
        f"-------------------------\n"
    )
    print(largest_conunty_turnout)

    # 8: Save the county with the largest turnout to a text file.
    txt_file.write(largest_conunty_turnout)
